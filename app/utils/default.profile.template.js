...
surface_speeds = ${data.surface_speeds}

-- max speed for tracktypes
tracktype_speeds = ${data.tracktype_speeds}

-- max speed for smoothnesses
smoothness_speeds = ${data.smoothness_speeds}

-- http://wiki.openstreetmap.org/wiki/Speed_limits
maxspeed_table_default = ${data.maxspeed_table_default}

-- List only exceptions
maxspeed_table = ${data.maxspeed_table}
