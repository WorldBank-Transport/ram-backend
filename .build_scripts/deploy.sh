...
ecs-cli compose --verbose --project-name ruralroads-backend --file ecs-task-definition-generated.yml service stop

echo "Deploying to ECS"
ecs-cli compose --verbose --project-name ruralroads-backend --file ecs-task-definition-generated.yml service up
